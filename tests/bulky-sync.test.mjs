...
test('BULKY validates and maps every supported spelling of the Netsuite header through one canonical key', async () => {
  assert.deepEqual(['Netsuite', 'NETSUITE', 'netsuite', ' Net Suite '].map(normalizeBulkyHeader), ['netsuite', 'netsuite', 'netsuite', 'netsuite']);
  for (const header of ['Netsuite', 'NETSUITE', 'netsuite', ' Net Suite ']) {
