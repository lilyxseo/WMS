...
test('inventory summary preserves dashboard, accuracy, warning and minus semantics', () => {
  const rows = {
    ...
    rpl: [
      { sku: 'A', nama_barang: 'Alpha', lokasi_bulky: 'AA-1-1-A', stok_akhir: 10 },
      { sku: 'B', nama_barang: 'Beta', lokasi_bulky: 'AA-1-1-B', stok_akhir: 12 },
    ],
    bulky: [
      { sku: 'A', nama_barang: 'Alpha', lokasi_bulky: 'A01-1', stok_akhir: 10, netsuite: 10 },
      { sku: 'B', nama_barang: 'Beta changed', lokasi_bulky: 'A01-1', stok_akhir: 12, netsuite: 10 },
    ],
    barangMasuk: [
...
test('accuracy uses BULKY Supabase NETSUITE only and excludes NULL references', () => {
  const summary = computeInventorySummary({
    kartuStok: [], rpl: [{ sku: 'A', stok_akhir: 999, netsuite: 999 }], barangMasuk: [], barangKeluar: [],
    bulky: [
